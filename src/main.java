...
public class main {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("请输入题目的数量1-1000");
       ...
       // boolean flag=true;
        ...
        for(i=0;i<n;i++){
            ...
            int numn=(int)(Math.random()*4);//随机生成一个0-3的整数,0表示3个运算数，1表示4个运算数，2表示5个运算数,3表示分数计算
            switch(numn)
            {
               case 0:
               ...
               case 2:
           	    ...
           	    break;
               case 3:
            	    num1=1+(int)(Math.random()*100);//随机生成一个0-100的整数
                    num2=1+(int)(Math.random()*100);//随机生成一个0-100的整数
                    num3=1+(int)(Math.random()*100);//随机生成一个0-100的整数
            	   int M,Z;
                   int x1,x2,x3;
